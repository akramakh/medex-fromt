...
export default function DoctorProfile() {
    ...
    let {authReducer: {user: doctor}} = useSelector(state => state);
    ...
    return (
        <div id="doctor-profile" className="container">
                    ...
                    <div className="doctor-widget">
                        ...
                        <div className="doc-info-right">
                            ...
                            <div className="clinic-booking">
                                <a className="btn btn-block btn-primary" href="/settings">Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
