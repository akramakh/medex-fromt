...
export default function AppointmentDetails({item, visible, onClose, onUpdate}) {
    ...
    const renderDoctorInfo = () => {
        const doctorName = doctor ? doctor.title ? `${doctor.first_name} ${doctor.last_name}` : doctor.username : "";
    ...
    const renderContent = () => {
        ...
        if (id === ""){
            ...
            return (
                ...
                {false ? <span onClick={() => setEdit(!edit)} className="edit-btn">
